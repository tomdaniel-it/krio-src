module['exports'] = {
    ...
    'settings.interface.streak': 'Show Streak',
    ...
    'settings.gameplay.lagComp': 'Lag Compensation',
    ...
    'settings.gameplay.aspectRatio': 'Aspect Ratio',
    ...
    'settings.controller.deadZoneL': 'Dead Zone (Left Stick)',
    'settings.controller.deadZoneR': 'Dead Zone (Right Stick)',
    ...
    'settings.editing.chatOp': 'Chat Opacity',
    'settings.editing.chatBGOp': 'Chat BG Opacity',
    ...
    'settings.mods.hitmarker': 'Hitmarker Image',
    'settings.mods.hitmarker.paste': 'Hitmarker Image URL',
    ...
    'windows.loadout.primary.attach': 'Primary Attachments',
    ...
    'server.config.hitBoxPad': 'Hitbox Scale',
    ...
    'queue.status.queued': 'Finding match [{0} in queue]',
    'queue.status.creating-game': 'Creating game',
    'queue.status.host': 'Creating game',
    'queue.status.join': 'Joining game',
    'queue.status.already-queued': 'Already queued in another tab',
